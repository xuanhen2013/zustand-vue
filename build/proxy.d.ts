...
export declare function defineProxy<T, S>(store: S, subscribeCache: TSubscribeCache, api: StoreApi<T>, selection?: (state: T) => S, equalityFn?: (a: S, b: S) => boolean): Readonly<Vue.Ref<Vue.DeepReadonly<Vue.UnwrapRef<S>>>>;
